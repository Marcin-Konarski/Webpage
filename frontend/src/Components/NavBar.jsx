        ...
        <>
            ...
            style={{
                ...
                <div className="container flex items-center justify-between">
                    ...
                    {/* Desktop NavBar */}
                    <div className="hidden md:flex items-center space-x-8 mr-10 font-bold">
                        {navItems.map((item) => {
                            return item.isNewPage
                                ? (
                                    <NavLink 
                                        key={item.name} 
                                        to={item.to} 
                                        className="group text-foreground/80 transition-colors duration-300"
                                    >
                                        <span className={cn(
                                            "bg-left-bottom bg-gradient-to-t from-current to-current",
